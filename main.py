...
# PURBI CHAMPARAN
# KISHANGANJ
# MUZAFFARPUR........then its district name ..you have to consider it as district name \

# For exmaple if question is: 

# how many shg in patna....then sql query should be
# sql: SELECT COUNT(c.CBO_ID) AS shg_count
#                             FROM m_cbo c
...
#                             AND upper(d.DISTRICT_NAME) = 'PATNA'.......you can see in this query patna is taken as district by default when user didnot specified any thing about patna.... \
# But if user question is like this:
# how many shg in patna block... then sql query should be
# sql: SELECT COUNT(c.CBO_ID) AS shg_count
#                             FROM m_cbo c
#                             INNER JOIN m_cbo_type t ON c.CBO_TYPE_ID = t.CBO_TYPE_ID  
#                             INNER JOIN m_block d ON c.BLOCK_ID = d.BLOCK_ID
#                             WHERE upper(t.TYPE_SHORT_NAME) = 'SHG' 
#                             AND upper(d.BLOCK_NAME) = 'PATNA' .....you can see in this query same patna is used as block as user quer has specified in question patna block.... \
...
# Thakurganj
# Ghailarh
# Dalsinghsarai...then its block name ....you have to consider it as block name\
...
# Detail information about table and its columns are as follows:-                                                                                                                                                                                       For example if question is like 
